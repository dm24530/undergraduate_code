...
/**
 * Servlet implementation class Servlettianjiarenwu
 */
@WebServlet(asyncSupported = true, urlPatterns = { "/Servlettianjiarenwu" })
public class Servlettianjiarenwu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(count>0) {
			...
			response.setHeader("refresh", "3;url=Servletyuangong");
		}else {
